                    ...
                    <table class="table table-sm table-borderless" id="customRow">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="<?=$third;?>" class="p-0 border-0">
                                    <input type="number" min="0" max="10000" class="form-control orange-input-bg-color border-dark rounded-0" data-editor-field="height" value="100" id="height" />
                                </td>
                            </tr>
                            <tr>
                                <td width="<?=$first;?>">&nbsp;</td>
                                ...
                                <td width="<?=$third;?>" class="p-0 border-0">
                                    <input type="number" min="0" max="10000" class="form-control orange-input-bg-color border-dark rounded-0" data-editor-field="width" value="100" id="width" />
                                </td>
                            </tr>
                            <tr>
                                <td width="<?=$first;?>">&nbsp;</td>
                                ...
                                <td width="<?=$third;?>" class="p-0 border-0">
                                    <input type="number" min="0" max="10000" class="form-control orange-input-bg-color border-dark rounded-0" data-editor-field="depth" value="5" id="depth" />
                                </td>
                            </tr>
