...
<head>
  ...
  <link rel="stylesheet" href="<?php echo site_url('plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css');?>">
  ...
  <link rel="stylesheet" href="<?php echo site_url('plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css');?>">
  <!-- BS Stepper -->
  <link rel="stylesheet" href="<?php echo site_url('plugins/bs-stepper/css/bs-stepper.min.css');?>">
  <!-- dropzonejs -->
...
<!-- Bootstrap4 Duallistbox -->
<script src="<?php echo site_url('plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js'); ?>"></script>
<!-- InputMask -->
...
<!-- Bootstrap Switch -->
<script src="<?php echo site_url('plugins/bootstrap-switch/js/bootstrap-switch.min.js'); ?>"></script>
<!-- BS-Stepper -->
<script src="<?php echo site_url('plugins/bs-stepper/js/bs-stepper.min.js'); ?>"></script>
<!-- dropzonejs -->
