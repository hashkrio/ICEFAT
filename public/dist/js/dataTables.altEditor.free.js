            ...
            _openEditModal: function () {
                ...
                for (var j in columnDefs) {
                    if (columnDefs[j].name != null) {
                        ...
                        if (typeof selectedValue !== 'object' && selectedValue !== null && typeof selectedValue !== 'undefined') {
                ...
                for (var j in columnDefs) {
                    ...
                    if (columnDefs[j].type.indexOf("hidden") >= 0) {
                        ...
                        if (columnDefs[j].inline) { //to add upto 4 inline columns
                            if(count == 0) {
                                count++;
                                data += "<div style='margin-left: initial;margin-right: initial;' class='m-0 form-group row' id='alteditor-row-" + this._quoteattr(columnDefs[j].name) + "'>";
                                data += "<div class='col-sm-6 col-md-6 col-lg-6 text-right'>";
